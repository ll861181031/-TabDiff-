...
def main(args):
    ...
    balance_target = getattr(args, 'balance_target', None)
    trainer = Trainer(
        diffusion,
        train_loader,
        train_data,
        ...
        **raw_config['train']['main'],
        ...
        ckpt_path=ckpt_path,
        y_only=args.y_only,
        weather_exclusive=args.weather_exclusive,
    ...
    if args.mode == 'test':
        if args.report:
            if  is_dcr:
                ...
                trainer.report_test(args.num_runs, balance_target=balance_target)
        elif args.impute:
            ...
            trainer.test(balance_target=balance_target)
    else:
        ## Save config
