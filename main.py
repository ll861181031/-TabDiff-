...
if __name__ == '__main__':
    ...
    parser.add_argument('--balance_target', type=str, default=None, choices=['equal', 'max_class', 'supplement'],
                       help='Balance target classes. "equal": divide samples equally (e.g., 20%% each for 5 classes). "max_class": all classes match majority class count. "supplement": supplement minority classes with synthetic data to reach target count per class')
    ...
    parser.add_argument('--weather_exclusive', action='store_true', help='Enable weather column mutual exclusivity constraint for avoid dataset')
